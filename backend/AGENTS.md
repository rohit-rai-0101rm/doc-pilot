...
- OpenAI Python SDK as HTTP client for xAI Grok (chat + embeddings at `https://api.x.ai/v1`)
...
- Integration tests go behind `@pytest.mark.integration` and may require live xAI / Supabase credentials.
